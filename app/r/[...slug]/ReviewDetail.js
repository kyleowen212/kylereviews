...
export default function ReviewDetail({ review }) {
  ...
  // Pre-process body: ensure blank lines between paragraphs are preserved
  // by normalizing \r\n to \n, then ensuring double newlines stay as paragraph breaks
  const processedBody = (review.body || '')
    .replace(/\r\n/g, '\n')
    .replace(/\n{3,}/g, '\n\n');
